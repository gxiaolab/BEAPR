...
void Prep::preProc_gio( std::string inBamfname ,std::string Ref_fname ,std::string tmpdir ,std::string prefix){
...
//
//std::map<std::string, std::vector<std::string> > Prep::sep_mp_byChrms(std::string  mp_fname , std::string tmpdir , std::string prefix ){
//	
////	
//  fstream filestr;
//  string str;
